...
const AuthRegister = () => {
  return (
    <div className="min-h-screen bg-pink-50 w-full p-4 flex items-center justify-center">
      <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 md:p-8 w-full max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl">
        {/* Header */}
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-pink-600 mb-2">Create your account</h1>
        ...
        <form className="space-y-4">
          ...
          <div>
            ...
            <div className="flex">
              ...
              <input
                ...
                className="flex-1 px-4 py-2 border border-gray-300 rounded-r-lg focus:ring-2 focus:ring-pink-500 focus:border-pink-500 outline-none transition"
                required
              />
            </div>
          </div>
          ...
          <button
            type="submit"
            className="w-full bg-pink-600 hover:bg-pink-700 text-white py-3 px-4 rounded-lg transition flex items-center justify-center"
          >
        ...
        <div className="mt-6 text-center text-sm text-gray-600">
          <p>Already have an account? <a href="#" className="text-pink-600 hover:underline">Sign in</a></p>
        </div>
      </div>
    </div>
  );
