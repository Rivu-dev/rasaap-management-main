  ...
  return (
    <div className="p-4 sm:p-6 max-w-full sm:max-w-5xl mx-auto space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <h2 className="text-2xl font-bold text-indigo-600">Services</h2>
      </div>
            ...
            >
              ...
              <div>
                ...
                <select
                  ...
                  value={form.product}
                  onChange={handleChange}
                  className="w-full px-4 py-2 rounded-lg border border-gray-200 focus:border-red-500 focus:ring-2 focus:ring-red-200 outline-none transition bg-gray-50 text-gray-400"
                  required
                >
          ...
          <tbody>
            {data.map((company) => (
              ...
              >
                ...
                <td className="px-2 sm:px-6 py-4">{company.image}</td>
